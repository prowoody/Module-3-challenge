...
# In addition, your final script should both print the analysis to the terminal and export a text file with the results.
  ...
  # Print the results to "PyPoll.txt" file
    print("Election Results", file=open("Analysis.txt", "a"))
    print("----------------------------", file=open("Analysis.txt", "a"))
    print(f"Total Votes: {row_count:,}", file=open("Analysis.txt", "a"))
    print("----------------------------", file=open("Analysis.txt", "a"))
    for k in range (0,candicount): 
        print(f"{candidate_list[k]}: {percentage[k]:.3%} ({votes[k]:,})", file=open("Analysis.txt", "a"))
    print("----------------------------", file=open("Analysis.txt", "a"))
    print(f"Winner: {candidate_list[winner]}", file=open("Analysis.txt", "a"))
    print("----------------------------", file=open("Analysis.txt", "a"))